            ...
            TextSpan(
              children: [
                WidgetSpan(
                  ...
                  child: Icon(Icons.star, size: 16, color: forgroundColor),
                ),
                TextSpan(text: " $label"),
              ],
            ),
            style: theme.textTheme.bodyLarge?.copyWith(color: forgroundColor),
          ),
        ),
      ),
    );
...
class CategoryTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      visualDensity: const VisualDensity(horizontal: -2.75, vertical: -4),
      contentPadding: const EdgeInsetsDirectional.symmetric(
        horizontal: 16,
        vertical: 4,
      ),
      ...
      tileColor: isSelected
          ...
          : null,
      leading: AnimageWidget(imagePath: category.imagePath),
      minLeadingWidth: 20,
      title: Text(category.name, maxLines: 1, overflow: TextOverflow.ellipsis),
      titleTextStyle: theme.textTheme.bodyLarge?.copyWith(
        color: highlightColor,
      ),
      trailing: Icon(Icons.arrow_forward_ios, size: 16, color: highlightColor),
    );
  }
}
